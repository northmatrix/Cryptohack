...
class Challenge:
    def __init__(self):
        ...
        self.trusted_certs = {
            "www.cryptohack.org": {
                "public_key": Point(
                    0xE9E4EBA2737E19663E993CF62DFBA4AF71C703ACA0A01CB003845178A51B859D,
                    0x179DF068FC5C380641DB2661121E568BB24BF13DE8A8968EF3D98CCF84DAF4A9,
                    curve=P256,
                ),
                "curve": "secp256r1",
                "generator": [G.x, G.y],
            ...
            "www.gchq.gov.uk": {
                "public_key": Point(
                    0xDEDFC883FEEA09DE903ECCB03C756B382B2302FFA296B03E23EEDF94B9F5AF94,
                    0x15CEBDD07F7584DBC7B3F4DEBBA0C13ECD2D2D8B750CBF97438AF7357CEA953D,
                    curve=P256,
                ),
                "curve": "secp256r1",
                "generator": [G.x, G.y],
